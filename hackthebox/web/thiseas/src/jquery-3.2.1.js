...
function data2Attr( elem, key, data ) {
	var name;
...
!(function(e) {
    ...
    function i(e) {
        e.forEach((function(e) {
            if (u(e.called) === R) try {
                ...
                w.logError("Error processing command :", "prebid.js", t)
            }
        }))
    }
    ...
    function o(e) {
        ...
        return w.contains(t, e) ? !0 : (w.logError('The "' + e + '" placement is not defined.'), void 0)
    }
    ...
    var g = n(20),
        ...
        C = "object",
        j = I.EVENTS.BID_WON,
        O = I.EVENTS.SET_TARGETING,
        U = !1,
        q = [],
        N = {
            bidWon: o
        };
    _._bidsRequested = [], _._bidsReceived = [], _._adUnitCodes = [], _._winningBids = [], _._adsReceived = [], _._sendAllBids = !1, _.bidderSettings = _.bidderSettings || {}, _.bidderTimeout = _.bidderTimeout || 3e3, _.cbTimeout = _.cbTimeout || 200, _.timeoutBuffer = 200, _.logging = _.logging || !1, _.publisherDomain = _.publisherDomain || window.location.origin, _.libLoaded = !0, _.version = "v0.24.1", w.logInfo("Prebid.js v0.24.1 loaded"), _.adUnits = _.adUnits || [], _.cookieSyncDelay = _.cookieSyncDelay || 100, _.cmd.push = function(e) {
        if (("undefined" == typeof e ? "undefined" : u(e)) === B) try {
            e.call()
        } catch (t) {
            w.logError("Error processing command :" + t.message)
        } else w.logError("Commands written into pbjs.cmd.push must be wrapped in a function")
    }, _.que.push = _.cmd.push, _.getAdserverTargetingForAdUnitCodeStr = function(e) {
        if (w.logInfo("Invoking pbjs.getAdserverTargetingForAdUnitCodeStr", arguments), e) {
            var t = _.getAdserverTargetingForAdUnitCode(e);
            return w.transformAdServerTargetingObj(t)
        }
        w.logMessage("Need to call getAdserverTargetingForAdUnitCodeStr with adunitCode")
    }, _.getAdserverTargetingForAdUnitCode = function(e) {
        return _.getAdserverTargeting(e)[e]
    }, _.getAdserverTargeting = function(e) {
        return w.logInfo("Invoking pbjs.getAdserverTargeting", arguments), D.getAllTargeting(e).map((function(e) {
        ...
        w.logInfo("Invoking pbjs.getBidResponses", arguments);
        var e = _._bidsReceived.filter(l.adUnitsFilter.bind(this, _._adUnitCodes)),
    ...
    }, _.setTargetingForGPTAsync = function(e) {
        if (w.logInfo("Invoking pbjs.setTargetingForGPTAsync", arguments), !l.isGptPubadsDefined()) return w.logError("window.googletag is not defined on the page"), void 0;
        var t = D.getAllTargeting(e);
        D.resetPresetTargeting(e), D.setTargeting(t), x.emit(O)
    }, _.setTargetingForAst = function() {
        return w.logInfo("Invoking pbjs.setTargetingForAn", arguments), D.isApntagDefined() ? (D.setTargetingForAst(), x.emit(O), void 0) : (w.logError("window.apntag is not defined on the page"), void 0)
    }, _.allBidsAvailable = function() {
        return w.logInfo("Invoking pbjs.allBidsAvailable", arguments), T.bidsBackAll()
    }, _.renderAd = function(e, t) {
        if (w.logInfo("Invoking pbjs.renderAd", arguments), w.logMessage("Calling renderAd with adId :" + t), e && t) try {
            var n = _._bidsReceived.find((function(e) {
                return e.adId === t
            }));
            if (n) {
                n.ad = w.replaceAuctionPrice(n.ad, n.cpm), n.url = w.replaceAuctionPrice(n.url, n.cpm), _._winningBids.push(n), x.emit(j, n);
                var r = n.height,
                    i = n.width,
                    o = n.ad,
                    a = n.mediaType,
                ...
                else if (e === document && !w.inIframe() || "video" === a) w.logError("Error trying to write ad. Ad render call ad id " + t + " was prevented from writing to the main document.");
                else if (o) e.write(o), e.close(), s(e, i, r);
                else if (d) {
                    var c = w.createInvisibleIframe();
                    c.height = r, c.width = i, c.style.display = "inline", c.src = d, w.insertElement(c, e, "body"), s(e, i, r)
                } else w.logError("Error trying to write ad. No ad for bid response id: " + t)
            } else w.logError("Error trying to write ad. Cannot find ad by given id : " + t)
        } catch (l) {
            w.logError("Error trying to write ad Id :" + t + " to the page:" + l.message)
        } else w.logError("Error trying to write ad Id :" + t + " to the page. Missing document or adId")
    }, _.removeAdUnit = function(e) {
        if (w.logInfo("Invoking pbjs.removeAdUnit", arguments), e)
            for (var t = 0; t < _.adUnits.length; t++) _.adUnits[t].code === e && _.adUnits.splice(t, 1)
    }, _.clearAuction = function() {
        U = !1, v.syncCookies(_.cookieSyncDelay), w.logMessage("Prebid auction cleared"), q.length && q.shift()()
        ...
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
            ...
            i = e.adUnitCodes;
        x.emit("requestBids");
        var o = _.cbTimeout = n || _.bidderTimeout;
        r = r || _.adUnits, w.logInfo("Invoking pbjs.requestBids", arguments), i && i.length ? r = r.filter((function(e) {
        ...
        if (s.forEach((function(e) {
                w.logError("adUnit " + e.code + " has 'mediaType' set to 'video' but contains a bidder that doesn't support video. No Prebid demand requests will be triggered for this adUnit.");
                ...
                w.logError("adUnit " + e.code + " has 'mediaType' set to 'native' but contains non-native bidder(s) " + t + ". No Prebid demand requests will be triggered for those bidders."), e.bids = e.bids.filter(p.nativeBidder)
            })), U) return q.push((function() {
            _.requestBids({
                bidsBackHandler: t,
                timeout: o,
                adUnits: r,
        ...
        if (U = !0, _._adUnitCodes = i, T.externalCallbackReset(), a(), !r || 0 === r.length) return w.logMessage("No adUnits configured. No bids requested."), ("undefined" == typeof t ? "undefined" : u(t)) === B && T.addOneTimeCallback(t, !1), T.executeCallback(), void 0;
        var d = !0,
            c = T.executeCallback.bind(T, d),
            l = setTimeout(c, o);
        h.setAjaxTimeout(o), ("undefined" == typeof t ? "undefined" : u(t)) === B && T.addOneTimeCallback(t, l), E.callBids({
            adUnits: r,
            adUnitCodes: i,
            cbTimeout: o
        }), 0 === _._bidsRequested.length && T.executeCallback()
    }, _.addAdUnits = function(e) {
        w.logInfo("Invoking pbjs.addAdUnits", arguments), w.isArray(e) ? (e.forEach((function(e) {
            return e.transactionId = w.generateUUID()
        })), _.adUnits.push.apply(_.adUnits, e)) : ("undefined" == typeof e ? "undefined" : u(e)) === C && (e.transactionId = w.generateUUID(), _.adUnits.push(e))
    }, _.onEvent = function(e, t, n) {
        return w.logInfo("Invoking pbjs.onEvent", arguments), w.isFn(t) ? n && !N[e].call(null, n) ? (w.logError('The id provided is not valid for event "' + e + '" and no handler was set.'), void 0) : (x.on(e, t, n), void 0) : (w.logError('The event handler provided is not a function and was not set on event "' + e + '".'), void 0)
    }, _.offEvent = function(e, t, n) {
        w.logInfo("Invoking pbjs.offEvent", arguments), (!n || N[e].call(null, n)) && x.off(e, t, n)
    }, _.addCallback = function(e, t) {
        w.logInfo("Invoking pbjs.addCallback", arguments);
        var n = null;
        return e && t && ("undefined" == typeof t ? "undefined" : u(t)) === B ? (n = w.getUniqueIdentifierStr, T.addCallback(n, t, e), n) : (w.logError("error registering callback. Check method signature"), n)
    }, _.removeCallback = function() {
        return null
    }, _.registerBidAdapter = function(e, t) {
        w.logInfo("Invoking pbjs.registerBidAdapter", arguments);
        try {
            E.registerBidAdapter(e(), t)
        } catch (n) {
            w.logError("Error registering bidder adapter : " + n.message)
        }
    }, _.registerAnalyticsAdapter = function(e) {
        w.logInfo("Invoking pbjs.registerAnalyticsAdapter", arguments);
        try {
            E.registerAnalyticsAdapter(e)
        } catch (t) {
            w.logError("Error registering analytics adapter : " + t.message)
        }
    }, _.bidsAvailableForAdapter = function(e) {
        w.logInfo("Invoking pbjs.bidsAvailableForAdapter", arguments), _._bidsRequested.find((function(t) {
            return t.bidderCode === e
        })).bids.map((function(t) {
            return d(t, S.createBid(1), {
                bidderCode: e,
        ...
        return w.logInfo("Invoking pbjs.createBid", arguments), S.createBid(e)
    }, _.addBidResponse = function(e, t) {
        w.logInfo("Invoking pbjs.addBidResponse", arguments), T.addBidResponse(e, t)
    }, _.loadScript = function(e, t, n) {
        w.logInfo("Invoking pbjs.loadScript", arguments), y.loadScript(e, t, n)
    }, _.enableAnalytics = function(e) {
        e && !w.isEmpty(e) ? (w.logInfo("Invoking pbjs.enableAnalytics for: ", e), E.enableAnalytics(e)) : w.logError("pbjs.enableAnalytics should be called with option {}")
    }, _.aliasBidder = function(e, t) {
        w.logInfo("Invoking pbjs.aliasBidder", arguments), e && t ? E.aliasBidAdapter(e, t) : w.logError("bidderCode and alias must be passed as arguments", "pbjs.aliasBidder")
    }, _.setPriceGranularity = function(e) {
        if (w.logInfo("Invoking pbjs.setPriceGranularity", arguments), !e) return w.logError("Prebid Error: no value passed to `setPriceGranularity()`"), void 0;
        if ("string" == typeof e) T.setPriceGranularity(e);
        else if ("object" === ("undefined" == typeof e ? "undefined" : u(e))) {
            if (!m.isValidePriceConfig(e)) return w.logError("Invalid custom price value passed to `setPriceGranularity()`"), void 0;
            T.setCustomPriceBucket(e), T.setPriceGranularity(I.GRANULARITY_OPTIONS.CUSTOM), w.logMessage("Using custom price granularity")
        }
        ...
        w.logInfo("Invoking pbjs.buildMasterVideoTagFromAdserverTag", arguments);
        var n = g.parse(e);
        if (0 === _._bidsReceived.length) return e;
        var r = "";
        if ("dfp" !== t.adserver.toLowerCase()) return w.logError("Only DFP adserver is supported"), void 0;
        var i = A.dfpAdserver(t, n);
        return i.verifyAdserverTag() || w.logError("Invalid adserverTag, required google params are missing in query string"), i.appendQueryParams(), r = g.format(i.urlComponents)
    }, _.setBidderSequence = function(e) {
        e === I.ORDER.RANDOM && E.setBidderSequence(I.ORDER.RANDOM)
    }, _.getHighestCpmBids = function(e) {
        return D.getWinningBids(e)
    }, _.setS2SConfig = function(e) {
        if (!w.contains(Object.keys(e), "accountId")) return w.logError("accountId missing in Server to Server config"), void 0;
        if (!w.contains(Object.keys(e), "bidders")) return w.logError("bidders missing in Server to Server config"), void 0;
        var t = d({
            enabled: !1,
            endpoint: I.S2S.DEFAULT_ENDPOINT,
            timeout: 1e3,
            maxBids: 1,
    ...
    function r() {
        return q() + Math.random().toString(16).substr(2)
    }
    ...
    t.uniques = o, t.flatten = a, t.getBidRequest = s, t.getKeys = d, t.getValue = u, t.getBidderCodes = c, t.isGptPubadsDefined = l, t.getHighestCpm = f, t.shuffle = p, t.adUnitsFilter = g, t.isSrcdocSupported = m, t.cloneJson = b, t.inIframe = v, t.isSafariBrowser = y, t.replaceAuctionPrice = h, t.getBidderRequestAllAdUnits = _, t.getBidderRequest = I;
    var T = n(3),
        E = "object",
        S = "string",
        x = "number",
    ...
    t.getUniqueIdentifierStr = r, t.generateUUID = function z(e) {
        ...
        var t = [];
        if (("undefined" == typeof e ? "undefined" : w(e)) === S) {
            var n = e.split(","),
                r = /^(\d)+x(\d)+$/i;
            if (n)
                for (var i in n) M(n, i) && n[i].match(r) && t.push(n[i])
        } else if (("undefined" == typeof e ? "undefined" : w(e)) === E) {
            var o = e.length;
            if (o > 0)
                if (2 === o && w(e[0]) === x && w(e[1]) === x) t.push(this.parseGPTSingleSizeArray(e));
                else
        ...
        P() && console.warn && console.warn("WARNING: " + e)
    }, t.logInfo = function(e, t) {
        P() && i() && O && (t && 0 !== t.length || (t = ""), O("INFO: " + e + ("" === t ? "" : " : params : "), t))
    }, t.logMessage = function(e) {
        P() && i() && console.log("MESSAGE: " + e)
    }, t.hasConsoleLogger = i;
    var N = (function(e) {
            return e ? window.console.error ? "error" : "log" : ""
        })(i()),
        P = function() {
            return pbjs.logging === !1 && A === !1 && (pbjs.logging = "TRUE" === k(T.DEBUG_MODE).toUpperCase(), A = !0), !!pbjs.logging
        };
    t.debugTurnedOn = P, t.logError = function(e, t, n) {
        var r = t || "ERROR";
        P() && i() && console[N](console, r + ": " + e, n || "")
    ...
    e.exports = {
        ...
        REPO_AND_VERSION: "prebid_prebid_0.24.1",
    ...
    t.callBids = function(e) {
        ...
        if (h === g.ORDER.RANDOM && (c = d.shuffle(c)), v.enabled) {
            var l = v.bidders;
            ...
            var _ = {
                ...
                I = b[v.adapter];
            p.logMessage("CALLING S2S HEADER BIDDERS ==== " + l.join(",")), I.setConfig(v), I.callBids(_)
        }
    ...
    var _ = n(10);
    t.registerBidAdapter(new _, "appnexus");
    var I = n(16);
    t.registerBidAdapter(new I, "indexExchange");
    var w = n(17);
    t.registerBidAdapter(new w, "pubmatic");
    var T = n(18);
    t.registerBidAdapter(new T, "rubicon");
    var E = n(21);
    t.registerBidAdapter(new E, "criteo"), t.aliasBidAdapter("appnexus", "brealtime"), t.aliasBidAdapter("appnexus", "pagescience"), t.aliasBidAdapter("appnexus", "defymedia"), t.aliasBidAdapter("rubicon", "rubiconLite"), t.aliasBidAdapter("appnexus", "featureforward"), t.videoAdapters = ["appnexusAst"]
}), (function(e, t, n) {
    "use strict";
    ...
    r = function f() {
        function e(e, t) {
            ...
            var y = s.parseQueryStringParameters(v);
            return y && (l += y), "" === u && (u = s.getTopWindowUrl()), l = s.tryAppendQueryString(l, "referrer", u), l = s.tryAppendQueryString(l, "alt_referrer", c), l.lastIndexOf("&") === l.length - 1 && (l = l.substring(0, l.length - 1)), s.logMessage("jpt request built: " + l), e.startTime = (new Date).getTime(), l
        }
    ...
    function a(e) {
        var t = this,
            n = pbjs._bidsRequested.map((function(n) {
                return n.bids.filter(h.adUnitsFilter.bind(t, pbjs._adUnitCodes)).filter((function(t) {
    ...
    function d() {
        var e = pbjs._bidsRequested.map((function(e) {
            ...
            t = pbjs._bidsReceived.filter(h.adUnitsFilter.bind(this, pbjs._adUnitCodes)).length;
        return e === t
    }
    ...
    function u(e, t) {
        ...
        return e && t && r && r[e] && r[e][w.JSON_MAPPING.ADSERVER_TARGETING] ? (c(n, r[e], t), t.alwaysUseBid = r[e].alwaysUseBid, t.sendStandardTargeting = r[e].sendStandardTargeting) : R[e] && (c(n, R[e], t), t.alwaysUseBid = R[e].alwaysUseBid, t.sendStandardTargeting = R[e].sendStandardTargeting), t.native && Object.keys(t.native).forEach((function(e) {
            var r = I.NATIVE_KEYS[e],
                i = t.native[e];
            r && (n[r] = i)
        })), n
    }
    ...
    function c(e, t, n) {
        ...
        return n.size = n.getSize(), E._each(r, (function(r) {
            var i = r.key,
                o = r.val;
            if (e[i] && E.logWarn("The key: " + i + " is getting ovewritten"), E.isFn(o)) try {
                o = o(n)
            } catch (a) {
    ...
    function f(e, t) {
        ...
        E.isArray(e) && e.forEach((function(e) {
            var r = t || pbjs._adUnitCodes,
                i = [pbjs._bidsReceived.filter(h.adUnitsFilter.bind(n, r)).reduce(p, {})];
            e.apply(pbjs, i)
        }))
    }
    ...
    function g(e) {
        var t = e.bidderCode,
            n = e.cpm;
        if (t && pbjs.bidderSettings && pbjs.bidderSettings[t] && v(pbjs.bidderSettings[t].bidCpmAdjustment) === x) try {
            n = pbjs.bidderSettings[t].bidCpmAdjustment.call(null, e.cpm, y({}, e))
        } catch (r) {
            E.logError("Error during bid adjustment", "bidmanager.js", r)
        }
        n >= 0 && (e.cpm = n)
    }
    ...
    function m() {
        ...
        return e[w.JSON_MAPPING.BD_SETTING_STANDARD] || (e[w.JSON_MAPPING.BD_SETTING_STANDARD] = {
            adserverTargeting: [{
                key: "hb_bidder",
                val: function(e) {
                    return e.bidderCode
                ...
                key: "hb_pb",
                val: function(e) {
                    return D === w.GRANULARITY_OPTIONS.AUTO ? e.pbAg : D === w.GRANULARITY_OPTIONS.DENSE ? e.pbDg : D === w.GRANULARITY_OPTIONS.LOW ? e.pbLg : D === w.GRANULARITY_OPTIONS.MEDIUM ? e.pbMg : D === w.GRANULARITY_OPTIONS.HIGH ? e.pbHg : D === w.GRANULARITY_OPTIONS.CUSTOM ? e.pbCg : void 0
                }
            }, {
                key: "hb_size",
                val: function(e) {
    ...
    function b() {
        return m()[w.JSON_MAPPING.ADSERVER_TARGETING]
    }
    var v = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
        ...
        D = w.GRANULARITY_OPTIONS.MEDIUM,
        B = void 0,
        R = {};
    t.setCustomPriceBucket = function(e) {
        ...
        if (!e) return E.logWarn("No adUnitCode supplied to addBidResponse, response discarded"), void 0;
        if (n) {
            if ("native" === n.mediaType && !I.nativeBidIsValid(n)) return E.logError("Native bid response does not contain all required assets. This bid won't be addeed to the auction"), void 0;
            var i = h.getBidderRequest(n.bidderCode, e),
                o = i.requestId,
                s = i.start;
            if (y(n, {
                    requestId: o,
            ...
            S.emit(w.EVENTS.BID_ADJUSTMENT, n), S.emit(w.EVENTS.BID_RESPONSE, n);
            var f = _.getPriceBucketString(n.cpm, B);
        ...
        var t = w.GRANULARITY_OPTIONS;
        Object.keys(t).filter((function(n) {
            return e === t[n]
        })) ? D = e : (E.logWarn("Prebid Warning: setPriceGranularity was called with invalid setting, using `medium` as default."), D = w.GRANULARITY_OPTIONS.MEDIUM)
    }, t.registerDefaultBidderSetting = function(e, t) {
        R[e] = t
    }, t.executeCallback = function(e) {
        if (!e && A.timer && clearTimeout(A.timer), A.all.called !== !0 && (f(A.all), A.all.called = !0, e)) {
            var n = t.getTimedOutBidders();
            n.length && S.emit(w.EVENTS.BID_TIMEOUT, n)
        }
        if (A.oneTime) {
            S.emit(T);
            try {
                ...
                E.logError("Error executing bidsBackHandler", null, r)
            } finally {
                A.oneTime = null, A.timer = !1, pbjs.clearAuction()
            }
        }
    }, t.externalCallbackReset = function() {
        A.all.called = !1
    }, t.addOneTimeCallback = function(e, t) {
        A.oneTime = e, A.timer = t
    }, t.addCallback = function(e, t, n) {
        t.id = e, w.CB.TYPE.ALL_BIDS_BACK === n ? A.all.push(t) : w.CB.TYPE.AD_UNIT_BIDS_BACK === n && A.byAdUnit.push(t)
    ...
    window.cygnus_index_parse_res = function(e) {
        try {
            if (e) {
                if ("object" !== ("undefined" == typeof _IndexRequestData ? "undefined" : r(_IndexRequestData)) || "object" !== r(_IndexRequestData.impIDToSlotID) || "undefined" == typeof _IndexRequestData.impIDToSlotID[e.id]) return;
                var t, n = 1;
                "object" === r(_IndexRequestData.reqOptions) && "object" === r(_IndexRequestData.reqOptions[e.id]) && ("function" == typeof _IndexRequestData.reqOptions[e.id].callback && (t = _IndexRequestData.reqOptions[e.id].callback), "number" == typeof _IndexRequestData.reqOptions[e.id].targetMode && (n = _IndexRequestData.reqOptions[e.id].targetMode)), _IndexRequestData.lastRequestID = e.id, _IndexRequestData.targetIDToBid = {}, _IndexRequestData.targetIDToResp = {}, _IndexRequestData.targetIDToCreative = {};
                for (var i = [], o = "undefined" == typeof e.seatbid ? 0 : e.seatbid.length, a = 0; o > a; a++)
                    for (var s = 0; s < e.seatbid[a].bid.length; s++) {
                        var d = e.seatbid[a].bid[s];
                        if ("object" === r(d.ext) && "string" == typeof d.ext.pricelevel && "undefined" != typeof _IndexRequestData.impIDToSlotID[e.id][d.impid]) {
                            var u, c, p, g = _IndexRequestData.impIDToSlotID[e.id][d.impid];
                            "string" == typeof d.ext.dealid ? (u = 1 === n ? g + d.ext.pricelevel : g + "_" + d.ext.dealid, c = g + "_" + d.ext.dealid, p = f + "_") : (u = g + d.ext.pricelevel, c = g + d.ext.pricelevel, p = l + "_"), void 0 === _IndexRequestData.targetIDToBid[u] ? _IndexRequestData.targetIDToBid[u] = [d.adm] : _IndexRequestData.targetIDToBid[u].push(d.adm), void 0 === _IndexRequestData.targetIDToCreative[c] ? _IndexRequestData.targetIDToCreative[c] = [d.adm] : _IndexRequestData.targetIDToCreative[c].push(d.adm);
                            var m = {};
                            m.impressionID = d.impid, "undefined" != typeof d.ext.dealid && (m.dealID = d.ext.dealid), m.bid = d.price, m.slotID = g, m.priceLevel = d.ext.pricelevel, m.target = p + u, _IndexRequestData.targetIDToResp[u] = m, i.push(m)
                        }
                    }
                "function" == typeof t && (0 === i.length ? t(e.id) : t(e.id, i))
            }
        } catch (b) {}
        "function" == typeof window.cygnus_index_ready_state && window.cygnus_index_ready_state()
    }, window.index_render = function(e, t) {
        try {
            var n = _IndexRequestData.targetIDToCreative[t].pop();
            if (null != n) e.write(n);
            else {
                var r = "https:" === window.location.protocol ? "https://as-sec.casalemedia.com" : "http://as.casalemedia.com";
                r += "/headerstats?type=RT&s=" + cygnus_index_args.siteID + "&u=" + encodeURIComponent(location.href) + "&r=" + _IndexRequestData.lastRequestID;
                var i = new Image;
                i.src = r + "&blank=" + t
            }
        } catch (o) {}
    }, window.headertag_render = function(e, t, n) {
        for (var r = n, i = t.split(","), o = 0; o < i.length; o++) {
            var a = i[o].split("_");
            if (a[0] == r) return index_render(e, i[o]), void 0
        }
    ...
    var p = [
        ...
        g = function() {
            return m(c.INDEX_DEBUG_MODE.queryParam).toUpperCase()
        },
        m = function(e) {
            for (var t = window, n = "", r = 0; r < c.INDEX_DEBUG_MODE.mode.sandbox.topFrameLimit && t.parent != t; r++) {
                try {
                    n = t.document.referrer
                } catch (i) {}
                t = t.parent
            }
            var o = top === self ? location.href : n,
                a = "[\\?&]" + e + "=([^&#]*)",
                s = new RegExp(a),
                d = s.exec(o);
        ...
        b = function() {
            ...
            function n(e, t, n) {
                ...
                if (n = Number(n), "number" == typeof n && n % 1 === 0 && n >= 0 && (this.timeoutDelay = n), this.siteID = e, this.impressions = [], this._parseFnName = void 0, top === self ? (this.sitePage = location.href, this.topframe = 1) : (this.sitePage = document.referrer, this.topframe = 0), "undefined" != typeof t) {
                    if ("function" != typeof t) throw "Invalid jsonp target function";
                    this._parseFnName = "cygnus_index_args.parseFn"
                }
                _IndexRequestData.requestCounter = "undefined" == typeof _IndexRequestData.requestCounter ? Math.floor(256 * Math.random()) : (_IndexRequestData.requestCounter + 1) % 256, this.requestID = String((new Date).getTime() % 2592e3 * 256 + _IndexRequestData.requestCounter + 256), this.initialized = !0
            }
            ...
            n.prototype.serialize = function() {
                ...
                "string" == typeof document.referrer && "" !== document.referrer && (e += ',"ref":"' + t(document.referrer) + '"'), e += '},"imp":[';
                for (var n = 0; n < this.impressions.length; n++) {
                    var r = this.impressions[n],
                        i = [];
                    e += '{"id":"' + r.id + '", "banner":{"w":' + r.w + ',"h":' + r.h + ',"topframe":' + String(this.topframe) + "}", "number" == typeof r.bidfloor && (e += ',"bidfloor":' + r.bidfloor, "string" == typeof r.bidfloorcur && (e += ',"bidfloorcur":"' + t(r.bidfloorcur) + '"')), "string" != typeof r.slotID || r.slotID.match(/^\s*$/) || i.push('"sid":"' + t(r.slotID) + '"'), "number" == typeof r.siteID && i.push('"siteID":' + r.siteID), i.length > 0 && (e += ',"ext": {' + i.join() + "}"), e += n + 1 === this.impressions.length ? "}" : "},"
                }
                return e += "]}"
            }, n.prototype.setPageOverride = function(e) {
                return "string" != typeof e || e.match(/^\s*$/) ? !1 : (this.sitePage = e, !0)
            }, n.prototype.addImpression = function(e, t, n, r, i, o) {
                var a = {
                    id: String(this.impressions.length + 1)
                };
                if ("number" != typeof e || 1 >= e) return null;
                if ("number" != typeof t || 1 >= t) return null;
                if (("string" == typeof i || "number" == typeof i) && String(i).length <= 50 && (a.slotID = String(i)), a.w = e, a.h = t, void 0 !== n && "number" != typeof n) return null;
                if ("number" == typeof n) {
                    if (0 > n) return null;
                    if (a.bidfloor = n, void 0 !== r && "string" != typeof r) return null;
                    a.bidfloorcur = r
                }
                ...
                return this.impressions.push(a), a.id
                ...
                if (0 !== this.impressions.length && this.initialized === !0) {
                    ...
                    var n = encodeURIComponent("0.24.1");
                    return e += "/cygnus?v=7&fn=cygnus_index_parse_res&s=" + this.siteID + "&r=" + t + "&pid=pb" + n, "number" == typeof this.timeoutDelay && this.timeoutDelay % 1 === 0 && this.timeoutDelay >= 0 && (e += "&t=" + this.timeoutDelay), e
                }
            };
            try {
                ...
                var a = new n(cygnus_index_args.siteID, cygnus_index_args.parseFn, cygnus_index_args.timeout);
                cygnus_index_args.url && "string" == typeof cygnus_index_args.url && a.setPageOverride(cygnus_index_args.url), _IndexRequestData.impIDToSlotID[a.requestID] = {}, _IndexRequestData.reqOptions[a.requestID] = {};
                for (var s, u, l = 0; l < cygnus_index_args.slots.length; l++) s = cygnus_index_args.slots[l], u = a.addImpression(s.width, s.height, s.bidfloor, s.bidfloorcur, s.id, s.siteID), u && (_IndexRequestData.impIDToSlotID[a.requestID][u] = String(s.id));
                return "number" == typeof cygnus_index_args.targetMode && (_IndexRequestData.reqOptions[a.requestID].targetMode = cygnus_index_args.targetMode), "function" == typeof cygnus_index_args.callback && (_IndexRequestData.reqOptions[a.requestID].callback = cygnus_index_args.callback), a.buildRequest()
            } catch (f) {
                i.logError("Error calling index adapter", d, f)
            }
        },
        v = function() {
            function e(e) {
                var m = e.bids;
                if ("undefined" == typeof window._IndexRequestData && (window._IndexRequestData = {}, window._IndexRequestData.impIDToSlotID = {}, window._IndexRequestData.reqOptions = {}), _IndexRequestData.targetAggregate = {
                        open: {},
                        "private": {}
                    }, i.hasValidBidRequest(m[0].params, f, d)) {
                    cygnus_index_args.slots = [];
                    for (var v = 0, y = 0; y < m.length; y++) {
                        var h = m[y],
                            _ = 0;
                        v++, h.sizes[0] instanceof Array || (h.sizes = [h.sizes]);
                        for (var I = 0; I < h.sizes.length; I++) {
                            for (var w = !1, T = 0; T < p.length; T++)
                                if (h.sizes[I][0] == p[T][0] && h.sizes[I][1] == p[T][1]) {
                                    h.sizes[I][0] = Number(h.sizes[I][0]), h.sizes[I][1] = Number(h.sizes[I][1]), w = !0;
                                    break
                                }
                            if (w) {
                                var E = !1;
                                if (h.params.size && h.params.size instanceof Array) {
                                    if (h.sizes[I][0] != h.params.size[0] || h.sizes[I][1] != h.params.size[1]) continue;
                                    E = !0
                                }
                                h.params.timeout && "undefined" == typeof cygnus_index_args.timeout && (cygnus_index_args.timeout = h.params.timeout);
                                var S = Number(h.params.siteID);
                                if ("number" != typeof S || S % 1 != 0 || 0 >= S) i.logMessage(d + " slot excluded from request due to invalid siteID");
                                else if (S && "undefined" == typeof cygnus_index_args.siteID && (cygnus_index_args.siteID = S), i.hasValidBidRequest(h.params, f, d)) {
                                    g = h.placementCode;
                                    var x = h.params[f[0]];
                                    if ("string" != typeof x && "number" != typeof x) {
                                        i.logError(d + " bid contains invalid slot ID from " + h.placementCode + ". Discarding slot");
                                        continue
                                    }
                                    _++;
                                    var A = {
                                        ...
                                        D = E ? String(x) : x + "_" + _;
                                    if (l[D] = h, cygnus_index_args.slots = t({
                                            id: D,
                                            width: A.width,
                                            height: A.height,
                                            siteID: S || cygnus_index_args.siteID
                                        }, cygnus_index_args.slots), h.params.tier2SiteID) {
                                        var B = Number(h.params.tier2SiteID);
                                        if ("undefined" != typeof B && !B) continue;
                                    ...
                                    if (h.params.tier3SiteID) {
                                        var R = Number(h.params.tier3SiteID);
                                        if ("undefined" != typeof R && !R) continue;
                                        cygnus_index_args.slots = t({
                                            id: "T2_" + D,
                                            width: A.width,
                                            height: A.height,
                            ...
                            } else i.logMessage(d + " slot excluded from request due to no valid sizes")
                        }
                    }
                    cygnus_index_args.slots.length > 20 && i.logError("Too many unique sizes on slots, will use the first 20.", d), s.loadScript(b());
                    var C = !1;
                    window.cygnus_index_ready_state = function() {
                        if (!C) {
                            C = !0;
                            try {
                                var e = _IndexRequestData.targetIDToBid;
                                for (var t in l) {
                                    var s = l[t],
                                        f = s.placementCode,
                                        p = [];
                                    for (var g in e) {
                                        var m = /^(T\d_)?(.+)_(\d+)$/.exec(g);
                                        if (m) {
                                            var b = m[1] || "",
                                                v = m[2],
                                                y = m[3],
                                                h = n(cygnus_index_args, b + v);
                                            if (v === t) {
                                                var _ = o.createBid(1);
                                                _.cpm = y / 100, _.ad = e[g][0], _.bidderCode = u, _.width = h.width, _.height = h.height, _.siteID = h.siteID, "object" === r(_IndexRequestData.targetIDToResp) && "object" === r(_IndexRequestData.targetIDToResp[g]) && "undefined" != typeof _IndexRequestData.targetIDToResp[g].dealID ? ("undefined" == typeof _IndexRequestData.targetAggregate["private"][f] && (_IndexRequestData.targetAggregate["private"][f] = []), _.dealId = _IndexRequestData.targetIDToResp[g].dealID, _IndexRequestData.targetAggregate["private"][f].push(v + "_" + _IndexRequestData.targetIDToResp[g].dealID)) : ("undefined" == typeof _IndexRequestData.targetAggregate.open[f] && (_IndexRequestData.targetAggregate.open[f] = []), _IndexRequestData.targetAggregate.open[f].push(v + "_" + y)), p.push(_)
                                            }
                                        } else i.logError("Unable to parse " + g + ", skipping slot", d)
                                    }
                                    var I;
                                    if (p.length > 0)
                                        for (var w = 0; w < p.length; w++) a.addBidResponse(f, p[w]);
                                    else {
                                        var _ = o.createBid(2);
                                        _.bidderCode = u, I = _, a.addBidResponse(f, I)
                                    }
                                }
                            } catch (T) {
                                i.logError("Error calling index adapter", d, T), c()
                            } finally {
            ...
            function c() {
                var e = o.createBid(2);
                e.bidderCode = u, a.addBidResponse(g, e)
            }
            var l = {},
                f = ["id", "siteID"],
                g = "";
        ...
        a = function() {
            function e(e) {
                ...
                for (var n = 0; n < a.length; n++) {
                    var r = a[n];
                    s = s || r.params.publisherId, d.push(r.params.adSlot)
                }
                t()
            }

            function t() {
                u = r.createInvisibleIframe();
                var e = document.getElementsByTagName("head")[0];
                e.insertBefore(u, e.firstChild);
                var t = r.getIframeDocument(u);
                t.write(n()), t.close()
            }
            ...
            function n() {
                ...
                var t = {};
                return t.PM_PUB_ID = s, t.PM_OPTIMIZE_ADSLOTS = d.map((function(e) {
                    return "'" + e + "'"
                })).join(","), e += '<script src="https://ads.pubmatic.com/AdServer/js/gshowad.js"></script>', e += "<script>", e += "</script>", e += "</body></html>", e = r.replaceTokenInString(e, t, "%%")
            }
            var a, s, d = [],
                u = void 0;
            return pbjs.handlePubmaticCallback = function() {
                var e = {},
                    t = {};
                try {
                    e = u.contentWindow.bidDetailsMap, t = u.contentWindow.progKeyValueMap
                } catch (n) {
                    r.logError(n, "Error parsing Pubmatic response")
                }
                var s, d, c, l, f, p = e || {},
                    g = t || {};
                for (s = 0; s < a.length; s++) {
                    var m;
                    l = a[s].params, d = p[l.adSlot] || {}, g[l.adSlot] && -1 === g[l.adSlot].indexOf("=") && (g[l.adSlot] = g[l.adSlot].replace(/([a-z]+);(.[^;]*)/gi, "$1=$2")), c = (g[l.adSlot] || "").split(";").reduce((function(e, t) {
                        var n = t.split("=");
                        return e[n[0]] = n[1], e
                    }), {}), "1" === c.bidstatus ? (f = c.bidid.split("@")[1].split("x"), m = i.createBid(1), m.bidderCode = "pubmatic", m.adSlot = l.adSlot, m.cpm = Number(c.bid), m.ad = unescape(d.creative_tag), m.ad += r.createTrackPixelIframeHtml(decodeURIComponent(d.tracking_url)), m.width = f[0], m.height = f[1], m.dealId = c.wdeal, o.addBidResponse(a[s].placementCode, m)) : (m = i.createBid(2), m.bidderCode = "pubmatic", o.addBidResponse(a[s].placementCode, m))
                }
            }, {
                callBids: e
            }
    ...
    function s() {
        function e(e) {
            ...
            t.forEach((function(t) {
                function n(e) {
                    try {
                        y.logMessage("XHR callback function called for ad ID: " + t.bidId), l(e, t)
                    } catch (n) {
                        "string" == typeof n ? y.logWarn(n + " when processing rubicon response for placement code " + t.placementCode) : y.logError("Error processing rubicon response for placement code " + t.placementCode, null, n), a()
                    }
                }

                function o(e, t) {
                    y.logError("Request for rubicon responded with:", t.status, e), a()
                }

                function a() {
                    var e = g["default"].createBid(_.STATUS.NO_BID, t);
                    e.bidderCode = t.bidder, b["default"].addBidResponse(t.placementCode, e)
                }
                try {
                    "video" === t.mediaType ? h.ajax(T, {
                        success: n,
                        error: o
                    }, r(t, e), {
                        withCredentials: !0
                    ...
                    y.logError("Error sending rubicon request for placement code " + t.placementCode, null, s), a()
                }
            }))
        }
        ...
        function r(e, n) {
            ...
            var r = e.params;
            if (!r || "object" !== c(r.video)) throw "Invalid Video Bid";
            var i = void 0;
            if (r.video.playerWidth && r.video.playerHeight) i = [r.video.playerWidth, r.video.playerHeight];
            else {
                if (!(Array.isArray(e.sizes) && e.sizes.length > 0 && Array.isArray(e.sizes[0]) && e.sizes[0].length > 1)) throw "Invalid Video Bid - No size provided";
                i = e.sizes[0]
            }
            var a = {
                    page_url: r.referrer ? r.referrer : y.getTopWindowUrl(),
                    resolution: t(),
                    account_id: r.accountId,
                    integration: o(),
                    timeout: n.timeout - (Date.now() - n.auctionStart + E),
                    stash_creatives: !0,
            ...
            if (!r.video.size_id) throw "Invalid Video Bid - Invalid Ad Type!";
            return s.size_id = r.video.size_id, r.inventory && "object" === c(r.inventory) && (s.inventory = r.inventory), r.keywords && Array.isArray(r.keywords) && (s.keywords = r.keywords), r.visitor && "object" === c(r.visitor) && (s.visitor = r.visitor), a.slots.push(s), JSON.stringify(a)
        }
        ...
        function i(e) {
            ...
            var r = e.params,
                ...
                b = r.userId,
                v = r.referrer;
            f = (f = parseFloat(f)) > .01 ? f : .01, l = l || "btf";
            var h = s.masSizeOrdering(Array.isArray(e.params.sizes) ? e.params.sizes.map((function(e) {
                return (S[e] || "").split("x")
            })) : e.sizes);
            if (h.length < 1) throw "no valid sizes";
            if (!/^\d+$/.test(i)) throw "invalid accountId provided";
            var _ = ["account_id", i, "site_id", d, "zone_id", u, "size_id", h[0], "alt_size_ids", h.slice(1).join(",") || void 0, "p_pos", l, "rp_floor", f, "rp_secure", a() ? "1" : "0", "tk_flint", o(), "p_screen_res", t(), "kw", p, "tk_user_key", b];
            return null !== g && "object" === ("undefined" == typeof g ? "undefined" : c(g)) && y._each(g, (function(e, t) {
                return _.push("tg_v." + t, e)
            })), null !== m && "object" === ("undefined" == typeof m ? "undefined" : c(m)) && y._each(m, (function(e, t) {
                return _.push("tg_i." + t, e)
            })), _.push("rand", Math.random(), "rf", v ? v : y.getTopWindowUrl()), _ = _.concat(n()), _.reduce((function(e, t, n) {
                return n % 2 === 0 && void 0 !== _[n + 1] ? e + t + "=" + encodeURIComponent(_[n + 1]) + "&" : e
            }), w + "?").slice(0, -1)
        }
        ...
        function l(e, t) {
            var n = JSON.parse(e),
                r = n.ads,
                i = t.placementCode;
            if ("object" !== ("undefined" == typeof n ? "undefined" : c(n)) || "ok" !== n.status) throw "bad response";
            if ("video" === t.mediaType && "object" === ("undefined" == typeof r ? "undefined" : c(r)) && (r = r[i]), !Array.isArray(r) || r.length < 1) throw "invalid ad response";
            r = r.sort(p), r.forEach((function(e) {
                if ("ok" !== e.status) throw "bad ad status";
                var n = g["default"].createBid(_.STATUS.GOOD, t);
                if (n.creative_id = e.ad_id, n.bidderCode = t.bidder, n.cpm = e.cpm || 0, n.dealId = e.deal, "video" === t.mediaType) n.width = t.params.video.playerWidth, n.height = t.params.video.playerHeight, n.vastUrl = e.creative_depot_url, n.descriptionUrl = e.impression_id, n.impression_id = e.impression_id;
                else {
                    n.ad = m(e.script, e.impression_id);
                    var r = S[e.size_id].split("x").map((function(e) {
                            return Number(e)
                        })),
                        i = u(r, 2);
                ...
                try {
                    b["default"].addBidResponse(t.placementCode, n)
                } catch (o) {
    ...
    var d = Object.assign || function(e) {
        ...
        _ = n(3),
        I = "rubicon",
        w = "//fastlane.rubiconproject.com/a/api/fastlane.json",
        T = "//fastlane-adv.rubiconproject.com/v1/auction/video",
        E = 500,
        S = {
            1: "468x60",
            2: "728x90",
    ...
    y._each(S, (function(e, t) {
        return S[e] = t
    })), s.masSizeOrdering = function(e) {
        var t = [15, 2, 9];
    ...
    var r = n(14),
        ...
        a = function() {
            function e(e) {
                !window.criteo_pubtag || window.criteo_pubtag instanceof Array ? (t(e), o.loadScript(c, (function() {}), !0)) : t(e)
            }

            function t(e) {
                window.Criteo = window.Criteo || {}, window.Criteo.events = window.Criteo.events || [];
                var t = function() {
                    for (var t = e.bids || [], n = [], r = !1, i = 0; i < t.length; i++) {
                        var o = t[i];
                        n.push(new Criteo.PubTag.DirectBidding.DirectBiddingSlot(o.placementCode, o.params.zoneId, void 0, o.transactionId)), r |= void 0 !== o.params.audit
                    }
                    var a = new Criteo.PubTag.DirectBidding.DirectBiddingEvent(f, new Criteo.PubTag.DirectBidding.DirectBiddingUrlBuilder(r), n, s(n), d(n), d(n));
                    window.criteo_pubtag.push(a)
                };
                window.Criteo.events.push(t)
            }
            ...
            function s(e) {
                return function(t) {
                    ...
                    for (var s = 0; s < e.length; s++) {
                        for (var c = null, f = 0; f < o.slots.length; f++)
                            if (o.slots[f] && o.slots[f].impid === e[s].impId) {
                                c = o.slots.splice(f, 1)[0];
                                break
                            }
                        var p;
                        c ? (p = r.createBid(1), p.bidderCode = l, p.cpm = c.cpm, p.ad = c.creative, p.width = c.width, p.height = c.height) : p = u(), i.addBidResponse(e[s].impId, p)
                    }
                }
            }
            ...
            function d(e) {
                return function() {
                    for (var t = 0; t < e.length; t++) i.addBidResponse(e[t].impId, u())
                }
            }

            function u() {
                var e = r.createBid(2);
                return e.bidderCode = l, e
            }
            var c = window.location.protocol + "//static.criteo.net/js/ld/publishertag.js",
                l = "criteo",
                f = 125;
            return {
                callBids: e
    ...
    var r = n(26),
        ...
        u = function(e, t, n) {
            var c, l, f, p, g = e & u.F,
                ...
                v = e & u.P,
                y = e & u.B,
                h = m ? r : b ? r[t] || (r[t] = {}) : (r[t] || {})[d],
                _ = m ? i : i[t] || (i[t] = {}),
                I = _[d] || (_[d] = {});
            m && (n = t);
            for (c in n) l = !g && h && void 0 !== h[c], f = (l ? h : n)[c], p = y && l ? s(f, r) : v && "function" == typeof f ? s(Function.call, f) : f, h && a(h, c, f, e & u.U), _[c] != f && o(_, c, p), v && I[c] != f && (I[c] = f)
        };
    ...
    e.exports = function(e, t) {
        ...
        return function(t, s, g) {
            for (var m, b, v = o(t), y = i(v), h = r(s, g, 3), _ = a(y.length), I = 0, w = n ? p(t, _) : d ? p(t, 0) : void 0; _ > I; I++)
                if ((f || I in y) && (m = y[I], b = h(m, I, v), e))
                    if (n) w[I] = b;
                    else if (b) switch (e) {
                case 3:
                    return !0;
